...
2. Since [ACF](http://www.advancedcustomfields.com/) variables use underscores when they're generated by default, always use underscores in ACF variables to maintain consistency.
...
If you need to go desktop-first and use max-width queries, make sure your mixin naming conventions reflect that. (1000down, 600down, 400down...)

Be smart about defining your media queries and think about flexibility and scalability. Don't use a min- and max-width query when a min-width query will do.
